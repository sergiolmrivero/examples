...
class CGMarket(Market):
    ...
    Buyers are Households; sellers are CGFirms.
    Inherits the random matching logic from Market.
    """
...
class LaborMarket(Market):
    ...
    Buyers are CGFirms (labour demand); sellers are Households (labour supply).
    Inherits the random matching logic from Market.
    """
